  ...
  return (
    ...
    >
      <div className="flex items-center justify-between py-[.9rem] px-[1.5rem] max-w-[1140px] mx-auto">
        ...
        {/* LOGO WITH FINE BORDER WRAPPER */}
        <div className="nav-logo">
          <div className="p-1 border border-[rgba(245,166,35,0.3)] rounded-lg bg-[rgba(255,255,255,0.05)] inline-block">
            <img 
              src="/logo.png" 
            ...
            />
            <span style={{ display: 'none' }} className="font-['Syne'] text-[1.1rem] font-extrabold text-[#F5A623] px-2">
        ...
        <div className="hidden md:flex items-center gap-[2rem] nav-links">
          ...
          <a className="btn btn-primary px-[1.4rem] py-[.6rem] text-[14px]" href="https://wa.me/265987808110?text=Hi%20AJ%2C%20I%20want%20a%20free%20audit" target="_blank" rel="noreferrer">
            Free Audit →
          </a>
        </div>
      ...
      {/* MOBILE MENU PANEL */}
      <div className={`${isOpen ? 'flex' : 'hidden'} fixed top-[74px] left-0 right-0 bg-[#1B2A4A] z-[999] p-[1.5rem] flex-col gap-[1rem] border-b-2 border-[#F5A623] shadow-2xl`} id="mobileMenu">
        ...
        <a className="btn btn-primary justify-center mt-[.5rem]" href="https://wa.me/265987808110?text=Hi%20AJ%2C%20I%20want%20a%20free%20audit" target="_blank" rel="noreferrer">
          Get Free Audit →
        </a>
      </div>
    </nav>
